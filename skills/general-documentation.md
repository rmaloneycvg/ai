...
- `steering/orchestration/local-dev.md` — Project structure, Tilt topology, deploy patterns
...
- `skills/general-deploy.md` — Deploy commands to document
- `skills/general-test.md` — Test commands to document
