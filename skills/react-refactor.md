---
name: react-refactor
description: Pipeline sub-agent skill for frontend refactoring. Extracts components and hooks, migrates state management, optimizes performance, and removes dead code while maintaining a green test baseline. Invoked by the react-orchestrator.
---
