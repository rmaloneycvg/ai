...
description: Refactor existing application code — extracting components, migrating state management, restructuring API layers, or improving performance/accessibility. NOT for refactoring Kiro skills (use kiro-refactor-skill) or adding new features (use react-components or backend-rest-api-feature).
---
...
- `steering/orchestration/local-dev.md` — Running the full stack locally to validate refactors end-to-end
