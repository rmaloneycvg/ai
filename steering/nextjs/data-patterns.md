---
name: NextjsDataPatterns
description: Data fetching patterns for Next.js including server-side fetching, caching, revalidation, and migration from SPA patterns
inclusion: manual
fileMatchPattern: [
  "**/app/**/page.tsx",
  "**/app/**/route.ts",
