---
name: ReactDependencyGraph
description: Prescriptive dependency choices, patterns, and conventions for all React projects including state management, data fetching, and styling
inclusion: manual
fileMatchPattern: [
  "**/package.json",
  "**/src/**/*.tsx",
