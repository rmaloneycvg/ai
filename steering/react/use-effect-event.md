---
name: ReactUseEffectEvent
description: Steering for the experimental useEffectEvent hook — when to use, stability guarantees, and production readiness warnings
inclusion: manual
fileMatchPattern: [
  "**/src/**/*.tsx",
  "**/src/**/*.jsx",
