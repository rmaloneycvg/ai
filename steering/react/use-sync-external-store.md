---
name: ReactUseSyncExternalStore
description: Steering for useSyncExternalStore — subscribing to non-React state sources like browser APIs and third-party stores
inclusion: manual
fileMatchPattern: [
  "**/src/**/*.tsx",
  "**/src/**/*.jsx",
