---
name: ReactTanStackQuery
description: Steering for TanStack Query hooks — server state management, query key factories, cache invalidation, and optimistic updates
inclusion: manual
fileMatchPattern: [
  "**/src/**/*.tsx",
  "**/src/**/*.jsx",
