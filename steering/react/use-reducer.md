...
description: Steering for useReducer — managing complex state transitions, action-driven updates, and when to prefer over useState
inclusion: fileMatch
fileMatchPattern: ["**/src/**/*.tsx", "**/src/**/*.jsx","**/src/**/*.ts", "**/src/**/*.js"]
---
