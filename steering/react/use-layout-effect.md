---
name: ReactUseLayoutEffect
description: Steering for useLayoutEffect — measuring DOM before paint for positioning tooltips, popovers, and layout-dependent UI
inclusion: manual
fileMatchPattern: [
  "**/src/**/*.tsx",
  "**/src/**/*.jsx",
